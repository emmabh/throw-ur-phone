...
const PROJECT_TITLE = "Throw Your Phone";
const PROJECT_SHORT_TITLE = "Throw Phone";
const PROJECT_DESCRIPTION = "Throw your phone to view this site";
